...
public class SimpleDirectedGraphTest {
	...
	public void testAdjacentVertices() {
		...
		assertTrue("Get adjacent vertices", graph.adjacentVertices("3").containsAll(adjacentVertices));
	...
	public void testIncidentEdges() {
		...
		assertTrue("Get incident edges", graph.incidentEdges("3").containsAll(incidentEdges));
	...
	public void testOutDegree() {
		assertEquals("Get the right outdegree", graph.inDegree("3"), 1);
		assertEquals("Vertex doesn't exist", graph.inDegree("8"), -1);
	}
	...
	public void testIncomingVertices() {
		...
		assertTrue("Get incoming vertices", graph.incomingVertices("3").containsAll(incomingVertices));
	...
	public void testOutgoingVertices() {
		...
		assertTrue("Get outgoing vertices", graph.outgoingVertices("1").containsAll(outgoingVertices));
		assertNull("Vertex doesn't exist", graph.outgoingVertices("7"));
	}

	@Test
	public void testIncomingEdges() {
		Collection<String> incomingEdges = new LinkedList<String>(Arrays.asList(new String[]{"edge2-3", "edge1-3", "edge3-4"}));
		assertTrue("Get incident edges", graph.incidentEdges("3").containsAll(incomingEdges));
		assertNull("Vertex doesn't exist", graph.incidentEdges("7"));
	}
	...
	public void testOutgoingEdges() {
		...
		assertTrue("Get adjacent vertices", graph.incidentEdges("1").containsAll(outgoingEdges));
		assertNull("Vertex doesn't exist", graph.incidentEdges("7"));
	}
